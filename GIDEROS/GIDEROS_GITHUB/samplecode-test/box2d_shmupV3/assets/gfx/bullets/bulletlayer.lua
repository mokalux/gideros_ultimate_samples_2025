...
local texture = Texture.new("gfx/bullets/bullets_ts.png", false, {transparentColor = 0xbfdcbf})
...
--		local fixture = body:createFixture({shape = shape, isSensor = true, filter = {categoryBits = categoryBits, maskBits = maskBits}})
		body:createFixture({shape = shape, isSensor = true, filter = {categoryBits = categoryBits, maskBits = maskBits}})
