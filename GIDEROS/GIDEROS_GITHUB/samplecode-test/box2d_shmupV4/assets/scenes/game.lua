...
function Game:onBeginContact(event)
	...
	local bullet
	if spriteA.type == "playerBullet" or spriteA.type == "enemyBullet" then bullet = spriteA
	elseif spriteB.type == "playerBullet" or spriteB.type == "enemyBullet" then bullet = spriteB
	end
	if bullet ~= nil then
