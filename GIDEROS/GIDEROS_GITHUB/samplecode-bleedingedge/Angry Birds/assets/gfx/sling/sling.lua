...
function Sling:init()
	local sling1 = Bitmap.new(Texture.new("gfx/sling/sling1.png"))
	sling1:setPosition(28, 7)
	local sling2 = Bitmap.new(Texture.new("gfx/sling/sling2.png"))

	self.acorn = Bitmap.new(Texture.new("gfx/acorn.png"))
