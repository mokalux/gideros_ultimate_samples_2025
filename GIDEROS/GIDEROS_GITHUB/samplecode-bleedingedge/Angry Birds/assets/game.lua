...
function Game:init()
	...
	local sprite = nil
	sprite = Bitmap.new(Texture.new("gfx/bg.png"))
	self:addChild(sprite)

	sprite = Bitmap.new(Texture.new("gfx/sling/sling1.png"))
	...
	sprite = Bitmap.new(Texture.new("gfx/sling/sling2.png"))
	sprite:setPosition(self.slingx - 35, self.slingy - 35)
	self:addChild(sprite)

	sprite = Bitmap.new(Texture.new("gfx/fg.png"))
...
function Game:createAcorn()
	self.acorn = Bitmap.new(Texture.new("gfx/acorn.png", true))
...
function Game:createTarget(textureName, x, y, angle, isCircle, isStatic, isEnemy)
...
function Game:createTargets()
	-- First block
	self:createTarget("gfx/brick_2.png", 675, FLOOR_HEIGHT, 0, false, false, false)
	self:createTarget("gfx/brick_1.png", 741, FLOOR_HEIGHT, 0, false, false, false)
	self:createTarget("gfx/brick_1.png", 741, FLOOR_HEIGHT - 23, 0, false, false, false)
	self:createTarget("gfx/brick_3.png", 672, FLOOR_HEIGHT - 46, 0, false, false, false)
	self:createTarget("gfx/brick_1.png", 707, FLOOR_HEIGHT - 58, 0, false, false, false)
	self:createTarget("gfx/brick_1.png", 707, FLOOR_HEIGHT - 81, 0, false, false, false)

	self:createTarget("gfx/head_dog.png", 702, FLOOR_HEIGHT, 0, true, false, true)
    self:createTarget("gfx/head_cat.png", 680, FLOOR_HEIGHT - 58, 0, true, false, true)
    self:createTarget("gfx/head_dog.png", 740, FLOOR_HEIGHT - 58, 0, true, false, true)
 
	-- 2 bricks at the right of the first block
    self:createTarget("gfx/brick_2.png", 770, FLOOR_HEIGHT, 0, false, false, false)
    self:createTarget("gfx/brick_2.png", 770, FLOOR_HEIGHT + 46, 0, false, false, false)
 
	-- The dog between the blocks
    self:createTarget("gfx/head_dog.png", 830, FLOOR_HEIGHT, 0, true, false, true)

	-- Second block
    self:createTarget("gfx/brick_platform.png", 839, FLOOR_HEIGHT, 0, false, true, false)
    self:createTarget("gfx/brick_2.png", 854, FLOOR_HEIGHT - 28, 0, false, false, false)
    self:createTarget("gfx/brick_2.png", 854, FLOOR_HEIGHT - 28 - 46, 0, false, false, false)
    self:createTarget("gfx/head_cat.png", 881, FLOOR_HEIGHT - 28, 0, true, false, true)
    self:createTarget("gfx/brick_2.png", 909, FLOOR_HEIGHT - 28, 0, false, false, false)
    self:createTarget("gfx/brick_1.png", 909, FLOOR_HEIGHT - 28 - 46, 0, false, false, false)
    self:createTarget("gfx/brick_1.png", 909, FLOOR_HEIGHT - 28 - 46 - 23, 0, false, false, false)
    self:createTarget("gfx/brick_2.png", 882, FLOOR_HEIGHT - 108, 90, false, false, false)
end
