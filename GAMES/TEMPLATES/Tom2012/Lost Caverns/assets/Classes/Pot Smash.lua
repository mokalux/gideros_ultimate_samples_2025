PotSmash = Core.class(Sprite);

function PotSmash:init(scene)
--]]
	self.scene = scene;
	...
	local particles1 = self.scene.atlas[2]:getTextureRegion("pot-particles-1.png");
	local particles2 = self.scene.atlas[2]:getTextureRegion("pot-particles-2.png");

	---------------------------------------------------------------------
	-- particles 1
	---------------------------------------------------------------------

	local parts1 = CParticles.new(particles1, 3, 1.5, 0,"alpha")
	...
	local parts2 = CParticles.new(particles2, 4, 1, 0,"alpha")
