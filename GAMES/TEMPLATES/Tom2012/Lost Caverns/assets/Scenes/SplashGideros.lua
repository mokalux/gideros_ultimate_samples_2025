splashGideros = Core.class(Sprite)

function splashGideros:init()
...
print("********* Splash screen Gideros *********")
	...
	local menuBG = Bitmap.new(Texture.new("gfx/gideros logo.png", true))
...
function splashGideros:next(event)
...
function splashGideros:changeLevel()
