level12 = Core.class(Sprite)

function level12:init()
...
function level12:setup()
	...
	require("Classes/CatFlap")
	require("Classes/ClosingDoorUpDown")
	require("Classes/ClosingDoorSmall")
	...
	--require("Classes/Masher Up Down 2")
	--require("Classes/MasherWithSpring")
	require("Classes/MultiSpike")
	...
	self.worldHeight = 2500

	self.levelData = "Level Data/Level 12 Data.lua"
	...
	local bg = Background.new(self,"Backgrounds/bg12 background.png",self.worldWidth,self.worldHeight,"Backgrounds/bg12 foreground.png",self.worldWidth,self.worldHeight)
	...
	if(self.wind) then
		...
		-- (scene,minTimeBetween,maxTimeBetween,minDuration,maxDuration,atlas)
		local wind = Wind.new(self,25,40,2,4,19)
...
function level12:playLevelMusic()
...
function level12:onPause()

	print("************ LEVEL 12 Pause ************")
...
function level12:onExit()

	print("************ LEVEL 12 EXIT ************")
	
	unrequire("Classes/CatFlap")
	unrequire("Classes/ClosingDoorUpDown")
	unrequire("Classes/ClosingDoorSmall")
	unrequire("Classes/FlyingWraith")
	unrequire("Classes/FlyingSaw")
	unrequire("Classes/GiantSpinner")
	unrequire("Classes/MultiSpike")
	...
	unrequire("Classes/Wind")
	unrequire("Classes/WindObject")
	
	CatFlap = nil
	ClosingDoorUpDown = nil
	ClosingDoorSmall = nil
	FlyingWraith = nil
	FlyingSaw = nil
	GiantSpinner = nil
	MultiSpike = nil
