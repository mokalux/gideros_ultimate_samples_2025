...
function level6:setup()
	...
	self.levelData = "Level Data/Level 6 Data.lua"
...
function level6:playLevelMusic()
...
function level6:onResume()

	print("************ LEVEL 6 Resume ************")
