...
function level8:setup()
	...
	loadAtlas(14,"Atlas 14")
	loadAtlas(17,"Atlas 17")
	loadAtlas("Mud Tileset", "Mud Tileset")

	self.atlas = {}
	self.atlas[2] = atlasHolder[2]
	self.atlas[14] = atlasHolder[14]
	self.atlas[17] = atlasHolder[17]
	...
	self.lootBronzeTarget = 800

	self.lootSilverTarget = 1400

	self.lootGoldTarget = 2520
	...
	self.worldWidth = 1400
	self.worldHeight = 5000

	self.levelData = "Level Data/Level 8 Data.lua"
	...
	local class = SpritesOffScreen.new(self,800,800)
	self:addChild(class)
	...
	local bg = Background.new(self,"Backgrounds/bg6 background.png",self.worldWidth,self.worldHeight,"none")
	local bg = FixedBackground.new(self,"Backgrounds/bg6 foreground.png",1400,1400,0,0)
	
	--local bg = Background.new(self,"Backgrounds/bg6 background.png",self.worldWidth,self.worldHeight,"Backgrounds/bg6 foreground.png",self.worldWidth,self.worldHeight)
...
function level8:playLevelMusic()
...
function level8:onExit()

	print("************ LEVEL 6 EXIT ************")
	
	unrequire("Classes/Bullet")
	unrequire("Classes/CreeperBug")
	unrequire("Classes/DropSpider")
	unrequire("Classes/DropSpiderThread")
	unrequire("Classes/ExplodingFruit")
	unrequire("Classes/FixedBackground")
	unrequire("Classes/FlyingShooter")
