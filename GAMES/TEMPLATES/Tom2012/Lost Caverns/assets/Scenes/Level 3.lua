...
function level3:setup()
	...
	self.lootSilverTarget = 1300

	self.lootGoldTarget = 1560
	...
	self.levelData = "Level Data/Level 3 Data.lua"
	...
	local bg = Background.new(self,"none",self.worldWidth,self.worldHeight,"Backgrounds/bg3 foreground.png",self.worldWidth,self.worldHeight)
...
function level3:playLevelMusic()
...
function level3:onExit()
	...
	Ball = nil
	unrequire("Classes/DragBlock")
	DragBlock = nil
	unrequire("Classes/DragBlockDoor")
	DragBlockDoor = nil
	unrequire("Classes/DragBlockButton")
	DragBlockButton = nil
