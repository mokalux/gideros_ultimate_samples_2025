...
function level2:setup()
	...
	self.lootSilverTarget = 1000

	self.lootGoldTarget = 1680

	self.coinValue = 10

	self.minutesLeft = 3
	--self.minutesLeft = 999
	self.secondsLeft = 0


	-- World width and height (get from Rube - 1 square = 100 pixels
	self.worldWidth = 2700
	self.worldHeight = 5000

	self.levelData = "Level Data/Level 2 Data.lua"
	...
	local bg = Background.new(self,"Backgrounds/bg2 background.png",self.worldWidth,self.worldHeight,"Backgrounds/bg2 foreground.png",self.worldWidth,self.worldHeight)
...
function level2:playLevelMusic()
