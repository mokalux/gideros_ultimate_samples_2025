...
function level1:setup()
	...
	self.lootBronzeTarget = 260
	--self.lootBronzeTarget = 10

	self.lootSilverTarget = 450
	--self.lootSilverTarget = 20

	self.lootGoldTarget = 790
	--self.lootGoldTarget = 30
	...
	self.levelData = "Level Data/Level 1 Data.lua"
	...
	local bg = Background.new(self,"Backgrounds/bg1 background.png",self.worldWidth,self.worldHeight,"Backgrounds/bg1 foreground.png",self.worldWidth,self.worldHeight)
...
function level1:playLevelMusic()
