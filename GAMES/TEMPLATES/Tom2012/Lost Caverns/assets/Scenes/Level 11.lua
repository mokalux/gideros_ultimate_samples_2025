level11 = Core.class(Sprite)

function level11:init()
...
function level11:setup()
	...
	self.lootSilverTarget = 800

	self.lootGoldTarget = 2000
	...
	self.worldWidth = 8000
	self.worldHeight = 5000

	self.levelData = "Level Data/Level 11 Data.lua"
	...
	local class = SpritesOffScreen.new(self,420,360)
	self:addChild(class)
	...
	local bg = Background.new(self,"Backgrounds/bg11 background.png",self.worldWidth,self.worldHeight,"Backgrounds/bg11 foreground.png",self.worldWidth,self.worldHeight)
...
function level11:playLevelMusic()
...
function level11:onPause()

	print("************ LEVEL 11 Pause ************")
...
function level11:onExit()
	...
	unrequire("Classes/Masher Up Down 2")
