...
--	vPad = CTNTVirtualPad.new(stage, "Assets/vpad",  PAD.STICK_SINGLE, PAD.BUTTONS_FOUR, 20, 2)
	local texturevpad = TexturePack.new("gfx/vpad.txt", "gfx/vpad.png", true)
	--self.vPad = CTNTVirtualPad.new(self, texturevpad, PAD.STICK_SINGLE, PAD.BUTTONS_ONE, 100, 0)
	vPad = CTNTVirtualPad.new(stage, texturevpad, PAD.STICK_SINGLE, PAD.BUTTONS_FOUR, 20, 2)
