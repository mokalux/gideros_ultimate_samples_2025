...
function TTestObject:init(newSprite)
	...
	self.xPos = 160--math.random(0, application:getLogicalWidth()-(self.width))
	self.yPos = 240--math.random(0, application:getLogicalWidth()-(self.width))
...
function TTestObject:onEnterFrame(event)
	...
	self.m = self.m + (120 *  event.deltaTime)
end
