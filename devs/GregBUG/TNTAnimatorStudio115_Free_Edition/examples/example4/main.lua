...
local function onPauseAnimation(event)
	print(event.animationName.." ..animation PAUSED...")
end
local function onUnPauseAnimation(event)
	print(event.animationName.." ..animation UNPAUSED...")
end
...
crock.anim:addEventListener("ANIM_PAUSED", onPauseAnimation, event)  
crock.anim:addEventListener("ANIM_UNPAUSED", onUnPauseAnimation, event)  
