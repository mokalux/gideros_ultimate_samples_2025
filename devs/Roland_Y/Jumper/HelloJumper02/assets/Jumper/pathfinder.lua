...
-- Dependencies
local Utils     = require "Jumper/core/utils"
local Assert    = require "Jumper/core/assert"
...
local assert = assert
local type = type
local setmetatable, _getmetatable = setmetatable, getmetatable
...
local Finders = {
	...
	['THETASTAR'] = require "Jumper/search/thetastar",
...
function Pathfinder:annotateGrid() -- need to update with new GH PR https://github.com/Yonaba/Jumper/pull/62/files XXX
