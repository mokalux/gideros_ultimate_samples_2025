...
local Heuristics = {}
	...
	function Heuristics.MANHATTAN(nodeA, nodeB)
		local dx = -(nodeA._x - nodeB._x)<>(nodeA._x - nodeB._x)
		local dy = -(nodeA._y - nodeB._y)<>(nodeA._y - nodeB._y)
		return (dx + dy)
	end
...
--		return sqrt(dx*dx+dy*dy) 
		return sqrt(
			(nodeA._x - nodeB._x)*(nodeA._x - nodeB._x) +
			(nodeA._y - nodeB._y)*(nodeA._y - nodeB._y)
		) -- XXX
	end
