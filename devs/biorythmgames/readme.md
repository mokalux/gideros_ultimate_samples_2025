Gideros samples are a range of small demo projects using the Gideros SDK. In most cases, they are a direct port from one we made with the Corona SDK. Each sample is free to download and use.
