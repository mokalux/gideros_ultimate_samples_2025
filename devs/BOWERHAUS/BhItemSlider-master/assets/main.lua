local listItems =
	{
		"Aardvark", "Bee", "Cat", "Dog", "Elephant", "Fox", "Giraffe",
		"Hen", "Iguana", "Jellyfish", "Kangaroo", "Lion", "Monkey", "Newt",
		"Orangutan", "Pig", "Queen Bee", "Raptor", "Sea Lion", "Turtle",
		"Viper", "Worker Bee", "Zebra",
	}
...
-- Add event listeners
slider:addEventListener("selectionChanged", function()
	print(string.format("selection changed to %s", slider:getCurrentItem():getText()))
end)
	
slider:addEventListener("scrollStarted", function()
	print("scroll started")
end)

slider:addEventListener("scrollEnded", function()
	print("scroll ended")
end)

slider:setDisabledAlpha(0.8) -- 1
slider:setPosition(100, 0)

slider:addEventListener("scrolled", function()
...
slider:addEventListener("longPress", function(event)
