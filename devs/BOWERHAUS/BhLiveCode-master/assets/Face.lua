...
function Face:init()
	local face=Bitmap.new(Texture.new("Images/ClockFace.png"))
	face:setAnchorPoint(0.5, 0.5)
	self:addChild(face)
	
	-- Hour hand
	local hour=Bitmap.new(Texture.new("Images/HourHand.png"))
	...
	-- Minute hand
	local min=Bitmap.new(Texture.new("Images/MinuteHand.png"))
	...
	-- Second hand
	local sec=Bitmap.new(Texture.new("Images/SecondHand.png"))
	...
	-- Center
	local center=Bitmap.new(Texture.new("Images/Center.png"))
