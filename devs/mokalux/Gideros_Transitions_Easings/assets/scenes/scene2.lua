...
function Scene2:init()
	...
	local bmp = Bitmap.new(Texture.new("gfx/gideros-icon-1024.png"))
	bmp:setScale(0.6)
	bmp:setAlpha(1)
...
--	local btnrepeat = Buttons("REPLAY", 0xBF4141, 0xBF4141, "play or replay the transition")
	local btnrepeat = ButtonTextP9UDDT.new({
		pixelcolorup=0x00ff00, pixelcolordown=0xffff00,
	...
	btntimer:addEventListener("click", function()
		...
		btntimer:setText("TIMER "..mytimer)
		mySavePrefs()
	end)
...
-- GAME LOOP
function Scene2:onEnterFrame(e)
end
