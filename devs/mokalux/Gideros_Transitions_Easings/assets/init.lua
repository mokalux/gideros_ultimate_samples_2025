...
require "easing"
-- globals
myappwidth = application:getContentWidth()
myappheight = application:getContentHeight()
mytransition = 1 -- transitions index
myeasing = 1 -- easings index
mytimer = 1 -- timer
mytransitions = {
...
mytransitionstxt = {
	...
	"moveFromBottom", -- 3
	"moveFromTop", -- 4
	"moveFromLeftWithFade", -- 5
	"moveFromRightWithFade", -- 6
	"moveFromBottomWithFade", -- 7
	"moveFromTopWithFade", -- 8
	"overFromLeft", -- 9
	"overFromRight", -- 10
	"overFromBottom", -- 11
	"overFromTop", -- 12
	"overFromLeftWithFade", -- 13
	"overFromRightWithFade", -- 14
	"overFromBottomWithFade", -- 15
	"overFromTopWithFade", -- 16
	"fade", -- 17
	"crossFade", -- 18
	"flip", -- 19
	"flipWithFade", -- 20
