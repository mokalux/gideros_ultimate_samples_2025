...
local texture_sky = Texture.new("background/sky.png")
local bg_sky = Bitmap.new(texture_sky)

local texture_hills = Texture.new("background/hills.png")
local bg_hills = Bitmap.new(texture_hills)

local texture_trees = Texture.new("background/trees.png")
local bg_trees = Bitmap.new(texture_trees)

-- Player and cars
local texture_player = {Texture.new("sprites/player_straight.png", true),
						Texture.new("sprites/player_right.png", true),
						Texture.new("sprites/player_left.png", true),
						Texture.new("sprites/player_uphill_straight.png", true),
						Texture.new("sprites/player_uphill_right.png", true),
						Texture.new("sprites/player_uphill_left.png", true)}

local texture_panel = Texture.new("sprites/open_house_sign_0.png", true)
