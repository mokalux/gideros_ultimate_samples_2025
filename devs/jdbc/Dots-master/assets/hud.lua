...
function Hud.setup()
	...
	texture_powerup[1] = {
		Texture.new("gfx/gear_red.png"),
		Texture.new("gfx/gear_grey.png")
	}
	texture_powerup[2] = {
		Texture.new("gfx/trash_yellow.png"),
		Texture.new("gfx/trash_grey.png")
	}
	texture_powerup[3] = {
		Texture.new("gfx/hyperlink_green.png"),
		Texture.new("gfx/hyperlink_grey.png")
	}
	Hud.texture_powerup = texture_powerup
	Hud.texture_pause = Texture.new("gfx/pause-red.png")
end
...
function Hud:updateScore(list)
	...
	for i=1, #list do score = score + bonus end
