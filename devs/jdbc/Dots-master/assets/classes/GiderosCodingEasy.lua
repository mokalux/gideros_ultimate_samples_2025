...
function math.round(num, factor) 
	if factor then return factor*math.round(num/factor) -- round a number to the nearest factor
	else return math.floor(num+.5) -- round a number to the nearest integer
	end
end
...
function changeAllSetFunctions(class)
	...
	for k, v in pairs(newMethods) do class[k] = v end
end
...
--[[ fix if logical dimensions are not set ]]--
