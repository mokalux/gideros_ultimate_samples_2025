...
mouseJoint = gideros.class(Sprite)

--on scene initialization
function mouseJoint:init()
	local text = TextField.new(TTFont.new("tahoma.ttf", 20), "Mouse Joint example")
...
function mouseJoint:wall(x, y, width, height)
...
--running the world
function mouseJoint:onEnterFrame() 
...
function mouseJoint:onExitBegin()
