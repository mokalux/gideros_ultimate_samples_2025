...
pulleyJoint = gideros.class(Sprite)

--on scene initialization
function pulleyJoint:init()
	local text = TextField.new(TTFont.new("tahoma.ttf", 20), "Pulley Joint example")
...
function pulleyJoint:wall(x, y, width, height)
...
--running the world
function pulleyJoint:onEnterFrame() 
...
function pulleyJoint:onExitBegin()
