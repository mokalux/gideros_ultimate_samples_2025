...
weldJoint = gideros.class(Sprite)

--on scene initialization
function weldJoint:init()
	local text = TextField.new(TTFont.new("tahoma.ttf", 20), "Wield Joint example")
...
function weldJoint:wall(x, y, width, height)
...
--running the world
function weldJoint:onEnterFrame() 
...
function weldJoint:onExitBegin()
