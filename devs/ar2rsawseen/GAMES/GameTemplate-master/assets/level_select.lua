...
function level_select:init()
	...
	local backButton = Button.new(
		Bitmap.new(Texture.new("images/back_up.png", conf.textureFilter)),
		Bitmap.new(Texture.new("images/back_down.png", conf.textureFilter))
	)
	...
	timer:addEventListener(Event.TIMER, function()
		...
		if(gm:isUnlocked(curPack, i)) then
			box = Button.new(
				Bitmap.new(Texture.new("images/crate.png", conf.textureFilter)),
				Bitmap.new(Texture.new("images/crate.png", conf.textureFilter))
			)
			--level number
			box.cnt = i
			...
			box = Button.new(
				Bitmap.new(Texture.new("images/crate_locked.png", conf.textureFilter)),
				Bitmap.new(Texture.new("images/crate_locked.png", conf.textureFilter))
			)
		end
		group:addChild(box)
