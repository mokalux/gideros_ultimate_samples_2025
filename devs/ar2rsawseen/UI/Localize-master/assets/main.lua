...
Localize.changeLocale("lv_LV") -- "lv_LV", "ru_RU"
...
local text2 = TextField.new(font, "This is a simple string")
...
local textwrap = TextWrap.new(
	"Multi - line string\nFor TextWrap object",
	application:getContentWidth(),
	"center"
)
textwrap:setFont(font)
textwrap:setPosition(0,100)
